...
public class SignUpController {
	...
	public ModelAndView saveAsCustomer(ModelMap model, @Valid @ModelAttribute("user") UserDto dto,
			@RequestParam("company") String company, BindingResult result) {
	...
	public ModelAndView saveAsFreelancer(ModelMap model, @Valid @ModelAttribute("user") UserDto dto,
			@RequestParam("techChecked") String techChecked, BindingResult result) {
